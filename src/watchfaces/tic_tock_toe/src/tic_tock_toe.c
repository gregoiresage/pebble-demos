...
static Layer *boardLayer; // The board/grid
static Layer *playersLayer; // The player markers
static TextLayer *timeLayer; // The clock/"scoreboard"


// This is called whenever the `boardLayer` layer needs to be redrawn.
static void boardLayer_update_callback(Layer *me, GContext* ctx) {
...
static void graphics_draw_line_wide(GContext* ctx, GPoint p0, GPoint p1) {
...
static void drawCirclePlayer(GContext* ctx, GPoint center) {
...
static void drawCrossPlayer(GContext* ctx, GPoint center) {
...
static GPoint getCellCenter(unsigned int cellOffset) {
...
static const unsigned short SEQUENCE_FIRST_PLAYER_WINS[] = {DRAW_BLANK, 0, 8, 2, 1, 6, 3, 4, DRAW_WIN_LINE, DRAW_BLANK};
static const unsigned short SEQUENCE_SECOND_PLAYER_WINS[] = {2, 8, 5, 6, 7, 0, 4, 3, DRAW_WIN_LINE, DRAW_BLANK};
static const unsigned short SEQUENCE_NEITHER_PLAYER_WINS[] = {4, 2, 7, 1, 0, 8, 5, 3, 6, DRAW_BLANK};
...
static void retrieveCurrentGameState(DemoGameState *gameState) {
...
static void drawWinLine(GContext* ctx, GPoint leftmostPoint, GPoint rightmostPoint) {
...
static void drawGameState(GContext* ctx, const DemoGameState gameState) {
...
static void playersLayer_update_callback(Layer *me, GContext* ctx) {
