...
const int DAY_NAME_IMAGE_RESOURCE_IDS[] = {
  RESOURCE_ID_IMAGE_NOD_DAY_NAME_SUN,
  RESOURCE_ID_IMAGE_NOD_DAY_NAME_MON,
  RESOURCE_ID_IMAGE_NOD_DAY_NAME_TUE,
  RESOURCE_ID_IMAGE_NOD_DAY_NAME_WED,
  RESOURCE_ID_IMAGE_NOD_DAY_NAME_THU,
  RESOURCE_ID_IMAGE_NOD_DAY_NAME_FRI,
  RESOURCE_ID_IMAGE_NOD_DAY_NAME_SAT
};
...
static const int DATENUM_IMAGE_RESOURCE_IDS[] = {
  RESOURCE_ID_IMAGE_NOD_DATENUM_0,
  RESOURCE_ID_IMAGE_NOD_DATENUM_1,
  RESOURCE_ID_IMAGE_NOD_DATENUM_2,
  RESOURCE_ID_IMAGE_NOD_DATENUM_3,
  RESOURCE_ID_IMAGE_NOD_DATENUM_4,
  RESOURCE_ID_IMAGE_NOD_DATENUM_5,
  RESOURCE_ID_IMAGE_NOD_DATENUM_6,
  RESOURCE_ID_IMAGE_NOD_DATENUM_7,
  RESOURCE_ID_IMAGE_NOD_DATENUM_8,
  RESOURCE_ID_IMAGE_NOD_DATENUM_9
};
...
static const int BIG_DIGIT_IMAGE_RESOURCE_IDS[] = {
  RESOURCE_ID_IMAGE_NOD_NUM_0,
  RESOURCE_ID_IMAGE_NOD_NUM_1,
  RESOURCE_ID_IMAGE_NOD_NUM_2,
  RESOURCE_ID_IMAGE_NOD_NUM_3,
  RESOURCE_ID_IMAGE_NOD_NUM_4,
  RESOURCE_ID_IMAGE_NOD_NUM_5,
  RESOURCE_ID_IMAGE_NOD_NUM_6,
  RESOURCE_ID_IMAGE_NOD_NUM_7,
  RESOURCE_ID_IMAGE_NOD_NUM_8,
  RESOURCE_ID_IMAGE_NOD_NUM_9
};
...
static void update_display(struct tm *current_time) {
  ...
  if (!clock_is_24h_style()) {
    if (current_time->tm_hour >= 12) {
      ...
      set_container_image(&time_format_image, time_format_layer, RESOURCE_ID_IMAGE_NOD_PM_MODE, GPoint(17, 68));
    } else {
...
void ninety_one_dub_init(void) {
  ...
  background_image = gbitmap_create_with_resource(RESOURCE_ID_IMAGE_NOD_BACKGROUND);
  background_layer = bitmap_layer_create(layer_get_frame(window_layer));
  bitmap_layer_set_bitmap(background_layer, background_image);
  layer_add_child(window_layer, bitmap_layer_get_layer(background_layer));

  meter_bar_image = gbitmap_create_with_resource(RESOURCE_ID_IMAGE_NOD_METER_BAR);
  GRect frame = (GRect) {
    .origin = { .x = 17, .y = 43 },
  ...
  if (!clock_is_24h_style()) {
    time_format_image = gbitmap_create_with_resource(RESOURCE_ID_IMAGE_NOD_24_HOUR_MODE);
    GRect frame = (GRect) {
      .origin = { .x = 17, .y = 68 },
...
void ninety_one_dub_deinit(void) {
