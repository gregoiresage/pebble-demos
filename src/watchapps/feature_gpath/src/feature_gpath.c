#include "pebble.h"
#include "feature_gpath_create.h"
...
void feature_gpath_init() {
  ...
  gpathes_create(graphic_paths);
  house_path = graphic_paths[0];
  infinity_path = graphic_paths[1];
