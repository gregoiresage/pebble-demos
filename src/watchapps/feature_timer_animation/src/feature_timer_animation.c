...
#include "pebble.h"
#include "feature_timer_animation_gpath.h"
...
void feature_timer_animation_init(void) {
  ...
  feature_timer_animation_gpath_create(&square_path);
...
void feature_timer_animation_deinit(void) {
